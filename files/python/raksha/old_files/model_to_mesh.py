...
def stl_to_msh(stl_file, output_directory, minRadius=0.001): # Meshing using ftetwild
    ...
    float_tetwild_path = "/mnt/c/Users/rkona/Documents/advectionDiffusion/files/libs/ftetwild/build/FloatTetwild_bin"
...
def main(model_directory, output_directory, minRadius = 0.001):

    
    vtp_to_stl(model_directory, output_directory)
    stl_to_msh(output_directory + "/model.stl", output_directory + ".msh", minRadius)
