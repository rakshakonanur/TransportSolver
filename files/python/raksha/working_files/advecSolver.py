...
class TransportSolver:
    ...
    def setup(self):
        ...
        bc_left = Constant(self.mesh, dfx.default_scalar_type(self.c_val[0]))
        dof_left = locate_dofs_geometrical(W, lambda x: np.isclose(x[0], 0.0))
        self.bcs = [dirichletbc(bc_left, dof_left, W)]  # Only apply at inlet
